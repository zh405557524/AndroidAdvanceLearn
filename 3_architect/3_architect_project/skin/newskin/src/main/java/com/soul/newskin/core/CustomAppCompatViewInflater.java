package com.soul.newskin.core;

import android.content.Context;
import android.util.AttributeSet;
import android.view.View;

import com.soul.newskin.views.SkinnableButton;
import com.soul.newskin.views.SkinnableImageView;
import com.soul.newskin.views.SkinnableLinearLayout;
import com.soul.newskin.views.SkinnableRelativeLayout;
import com.soul.newskin.views.SkinnableTextView;

import androidx.appcompat.app.AppCompatViewInflater;

/**
 * Description: 自定义控件加载器（可以考虑该类不被继承）
 * Author: 祝明
 * CreateDate: 2021/12/31 12:00
 * UpdateUser:
 * UpdateDate: 2021/12/31 12:00
 * UpdateRemark:
 */
